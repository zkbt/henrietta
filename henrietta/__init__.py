...
taught at CU Boulder by Zach Berta-Thompsons
'''
...
if not __HENRIETTASETUP__:
    ...
    def whoisthisawesomelady():
        ...
        scientists to measure the size of the Universe for the first time. If you'd
        like to learn more about her, check out her
